...
def survival_doctrine() -> str:
    ...
    return (
        ...
        "  Water_RS producers/PotableWater <= 100  (reclaims dirty/grey water -> "
        "potable; the ONLY potable producer — your lever to keep potable positive)\n\n"
        ...
        "4. WATER: keep potable water positive. The crew + BiomassPS + OGS draw it; "
        "Water_RS reclaims dirty/grey water back into potable — drive Water_RS "
        "producers/PotableWater to close the loop. Note OGS electrolyzes potable to "
        "make O2, but only while actually producing O2 (it idles when O2_Store is full).\n"
