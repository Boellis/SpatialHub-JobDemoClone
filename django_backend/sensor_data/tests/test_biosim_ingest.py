...
No @pytest.mark.django_db decorator is needed: biosim_tick_to_rows constructs
EnrichedSensorData instances with Model.__init__() but never calls .save() or any
ORM query. The Django app registry is loaded by DJANGO_SETTINGS_MODULE in pytest.ini,
which is sufficient for model instantiation without a live database connection.
"""
